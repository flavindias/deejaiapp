    ...
    return (
      <nav className="navbar navbar-fixed-top navbar-expand-lg  navbar-dark bg-dark">
        <Link className="navbar-brand" to="/">
          <img src={process.env.PUBLIC_URL + '/logo.png'} alt={"deejai logo application"} className={"navbar-brand mr-0 mr-md-2"} style={logoStyle} />
        </Link>
        ...
        <div className="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
          <ul className="navbar-nav">
            ...
            <li className={`nav-item ${this.props.team ? 'active' : ''}`}>
